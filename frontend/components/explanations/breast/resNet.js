...
export default  function BreastResNet() {
  ...
  return (
    <div className="mb-2 pt-2 pb-2 h-full w-full">
      ...
      <div class="relative text-gray-500 text-lg flex-auto">
        ...
        After testing with more than 300 cases it was seen that the accuracy was greater than 85%
      </div>
      <div class="relative text-gray-500 text-lg flex-auto">
      ...
      <div class="relative text-gray-500 text-lg flex-auto">
        ...
        <img className="mt-4" src="images/lossBreast.JPG"/>
        <div className="font-bold">This is The Accuracy Evolution</div>
        <img className="mt-4" src="images/breastAcc.JPG"/>
        <img src="images/casesBreast.JPG"/>
        <img src="images/confusionBreast.JPG"/>
        <img src="images/trainBreastTable.JPG"/>
        <img src="images/restNetBreast.JPG"/>
      </div>
      ...
      <div class="ml-3 flot-left text-left relative text-gray-500 text-lg flex-auto">
        ...
        <ul>
          <li class="font-bold">Accuracy - (0.804, 0.915).</li>
          <li class="font-bold">Precision - (0.984, 1.003).</li>
          <li class="font-bold">Recall - (0.804, 0.915).</li>
          <li class="font-bold">FMeasure - (0.876, 0.954).</li>
        </ul>
        <div className='h-10'/>
      </div>
    </div>
