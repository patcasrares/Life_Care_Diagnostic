...
export default function CovidResNet() {
  ...
  return (
    <div className="mb-2 pt-2 pb-2 h-full w-full">
      ...
      <div class="ml-3 flot-left text-left relative text-gray-500 text-lg flex-auto">
        ...
        <ul>
          <li class="font-bold">Accuracy - (0.653, 0.694).</li>
          <li class="font-bold">Precision - (0.490, 0.683).</li>
          <li class="font-bold">Recall - (0.653, 0.694).</li>
          <li class="font-bold">FMeasure - (0.550, 0.599).</li>
        </ul>
        <div className='h-10'/>
      </div>
    </div>
