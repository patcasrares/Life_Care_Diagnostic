...
export default function FaceSequential() {
  ...
  return (
    <div className="mb-2 pt-2 pb-2 h-full w-full">
      ...
      <div class="ml-3 flot-left text-left relative text-gray-500 text-lg flex-auto">
        ...
        <ul>
          <li class="font-bold">Accuracy - (0.707, 0.788).</li>
          <li class="font-bold">Precision - (0.818, 0.899).</li>
          <li class="font-bold">Recall - (0.707, 0.788).</li>
          <li class="font-bold">FMeasure - (0.587, 0.695).</li>
        </ul>
        <div className='h-10'/>
      </div>
    </div>
